...
console.log('=========================================');
console.log('NATURAL ORGANIC - FICHA DE PRESENTACIÓN');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       Infusiones y tés - Uso medicinal y energizante');
...
console.log('Valor principal:    28000');
...
console.log('Valor calculado:    ', 28000 * 0.9); // Precio con 10% descuento para clientes frecuentes
...
console.log('Estado booleano 1:  ', true);  // esCertificadoOrganico

// TODO: Otro valor boolean diferente al anterior (true o false — sin comillas)
console.log('Estado booleano 2:  ', false); // contieneGluten
...
console.log('Dominio:          Tienda de Productos Orgánicos y Naturales');
...
console.log('Total registros:  214');
...
console.log('  ¡Consume consciente, vive en armonía!');
